/**
 * Package-owned invariant companion for `@buddhilive/dsh-typert-loader`.
 * @module @buddhilive/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-typert-loader'
