/** Package-owned durable retry-event invariants. @module @buddhilive/dsh-llm-retry/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { Session, SessionEvent } from '@buddhilive/dsh-session'
import type { LlmFailure } from '@buddhilive/dsh-llm'
...
const PACKAGE_NAME = '@buddhilive/dsh-llm-retry'
