/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-settings-models`.
 * @module @buddhilive/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-settings-models'
