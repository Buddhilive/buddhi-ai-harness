...
import { boot, healProfilesModuleFallback, loadOverlayPatches, loadProfile } from '@buddhilive/dsh-app-boot'
import { provideCmdline } from '@buddhilive/dsh-cmdline'
import { SessionId } from '@buddhilive/dsh-session'
import type { Agent } from '@buddhilive/dsh-agent'
import type { PatchOptions } from '@deepseek-ai/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it, vi } from 'vitest'
import { SUBAGENT_MODEL_SELECTION_SETTINGS_NAMESPACE } from '@buddhilive/dsh-tool-subagent/model-selection-settings'
import { SETTINGS_NAMESPACE, SHIPPED_PRESET_ROOT } from '@buddhilive/dsh-agent-presets'
import { applyChildComposition, childSessionMeta } from '@buddhilive/dsh-subagent'
import { ToolCallId } from '@buddhilive/dsh-llm'
import type {} from '@buddhilive/dsh-compaction-basic'
import type {} from '@buddhilive/dsh-skill'
import type {} from '@buddhilive/dsh-tools'
// Type-only: resolves `ctx.get('sessionProjections')` and `ctx.get('tokenMeter')`.
import type {} from '@buddhilive/dsh-session-projection'
import type {} from '@buddhilive/dsh-token-meter'
...
async function bootWeb(
  ...
  const overrides: PatchOptions[] = [
    ...
    { insert: [
      { id: 'directory-picker-browse', name: '@buddhilive/dsh-host-directory-picker-browse' },
      { id: 'ui-directory-picker-browse', name: '@buddhilive/dsh-client-ui-directory-picker-browse' },
    ] },
