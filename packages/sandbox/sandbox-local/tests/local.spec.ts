...
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@buddhilive/dsh-sandbox'
import type { SandboxPolicy } from '@buddhilive/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@buddhilive/dsh-sandbox-local'
import type { Config } from '@buddhilive/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @buddhilive/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
