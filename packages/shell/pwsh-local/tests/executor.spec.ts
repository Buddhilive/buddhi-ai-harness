/**
 * Real-process tests for `@buddhilive/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@buddhilive/dsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@buddhilive/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@buddhilive/dsh-timeout'
import type { ShellProcess } from '@buddhilive/dsh-shell'
