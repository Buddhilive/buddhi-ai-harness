/**
 * Package-owned invariant companion for `@buddhilive/dsh-token-meter`.
 * @module @buddhilive/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-token-meter'
