...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@buddhilive/dsh-session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@buddhilive/dsh-session'
