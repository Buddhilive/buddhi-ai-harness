/**
 * Package-owned invariant companion for `@buddhilive/dsh-api-gateway`.
 * @module @buddhilive/dsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-api-gateway'
