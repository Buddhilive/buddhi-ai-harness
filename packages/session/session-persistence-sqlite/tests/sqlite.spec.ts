...
import SessionPersistenceSqlite, {
  ...
  SCHEMA_VERSION,
} from '@buddhilive/dsh-session-persistence-sqlite'
import {
  ...
  it('loads from cordis.yml and packs through the assembled service', async () => {
    ...
    ctx.loader.internal = {
      ...
      async import(specifier: string) {
        if (specifier === '@buddhilive/dsh-session') return SessionStore
        if (specifier === '@buddhilive/dsh-session-persistence-sqlite') {
