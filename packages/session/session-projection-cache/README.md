...
The plugin injects `storageDomain`, `sessionProjections`, and `sessions`. The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-session-projection-cache) is the exhaustive source for every accepted field and its JSDoc.
