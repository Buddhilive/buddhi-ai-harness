/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-tool`.
 * @module @buddhilive/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-tool'
