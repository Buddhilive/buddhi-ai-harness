/** Package-owned invariant companion for the directory-picker seam. @module @buddhilive/dsh-host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@buddhilive/dsh-invariants'

const PACKAGE_NAME = '@buddhilive/dsh-host-directory-picker'
