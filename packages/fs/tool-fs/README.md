...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-tool-fs) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#buddhilivedsh-tool-fs) — the exhaustive schemas this package registers.
