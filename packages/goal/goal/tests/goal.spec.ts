...
import { createUserMessage, HarnessError } from '@buddhilive/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@buddhilive/dsh-session'
...
import GoalService, {
  ...
  decodeGoalChange,
  foldGoal,
} from '@buddhilive/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@buddhilive/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@buddhilive/dsh-session').SessionEvent[]): StubAgent {
