/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-subagent`.
 * @module @buddhilive/dsh-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-subagent'
