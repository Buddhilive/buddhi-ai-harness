/**
 * Package-owned invariant companion for `@buddhilive/dsh-sandbox-windows-acl`.
 * @module @buddhilive/dsh-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-sandbox-windows-acl'
