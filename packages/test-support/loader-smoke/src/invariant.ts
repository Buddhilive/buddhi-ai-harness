/**
 * Package-owned invariant companion for `@buddhilive/dsh-loader-smoke`.
 * @module @buddhilive/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-loader-smoke'
