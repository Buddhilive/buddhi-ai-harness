 ...
 * `@buddhilive/dsh-bash-sandbox`. It wraps the exact local pwsh argv through
...
import type {
  ...
  SandboxMode,
  SandboxPolicy,
} from '@buddhilive/dsh-sandbox'
import type {} from '@buddhilive/dsh-sandbox-policy'
import { PwshLocalExecutor } from '@buddhilive/dsh-pwsh-local'
import type { Config as LocalConfig } from '@buddhilive/dsh-pwsh-local'
