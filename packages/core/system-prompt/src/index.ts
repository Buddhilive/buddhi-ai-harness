 ...
 *
 * @module @buddhilive/dsh-system-prompt
 */

import { Context, Service } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { AnonymousEntries, NamedEntries, ScopedLayers, scopeTarget } from '@buddhilive/dsh-scope'
import type { ScopeKey, ScopeLayer, Scoped } from '@buddhilive/dsh-scope'
import type { ContextSnapshotSection, ToolSchema } from '@buddhilive/dsh-llm'
...
declare module '@deepseek-ai/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@buddhilive/dsh-scope`): scoped listeners
