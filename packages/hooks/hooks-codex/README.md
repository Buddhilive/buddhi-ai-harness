...
```yaml
- name: '@buddhilive/dsh-hooks-codex'
  config:
...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-hooks-codex) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-hooks-codex) — every accepted config field and its source declaration.
