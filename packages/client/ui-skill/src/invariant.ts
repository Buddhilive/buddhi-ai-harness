/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-skill`.
 * @module @buddhilive/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-skill'
