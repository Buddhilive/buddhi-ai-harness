/**
 * Package-owned invariant companion for `@buddhilive/dsh-anonymous-user-id`.
 * @module @buddhilive/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-anonymous-user-id'
