/**
 * Package-owned invariant companion for `@buddhilive/dsh-agent-loop-testkit`.
 * @module @buddhilive/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-agent-loop-testkit'
