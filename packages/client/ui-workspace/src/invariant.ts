/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-workspace`.
 * @module @buddhilive/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-workspace'
