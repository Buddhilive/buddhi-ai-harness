/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-title-first-prompt-llm`.
 * @module @buddhilive/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-title-first-prompt-llm'
