/**
 * Package-owned invariant companion for `@buddhilive/dsh-workflow-worker-thread`.
 * @module @buddhilive/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-workflow-worker-thread'
