/**
 * Package-owned invariant companion for `@buddhilive/dsh-typert-protocol`.
 * @module @buddhilive/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-typert-protocol'
