...
- [Generated tool catalog](../../docs/tool-catalog.md#buddhilivedsh-tool-cordis) — the seven model-facing tool schemas.
- [Generated configuration catalog](../../docs/config-catalog.md#buddhilivedsh-cordis-host-runner) — the runner's accepted config fields.
