/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-telemetry`.
 * @module @buddhilive/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-telemetry'
