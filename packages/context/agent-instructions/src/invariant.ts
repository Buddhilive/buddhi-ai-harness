/**
 * Package-owned invariant companion for `@buddhilive/dsh-agent-instructions`.
 * @module @buddhilive/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-agent-instructions'
