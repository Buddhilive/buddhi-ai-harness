/**
 * Package-owned invariant companion for `@buddhilive/dsh-settings-file`.
 * @module @buddhilive/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@buddhilive/dsh-settings`.
 */
