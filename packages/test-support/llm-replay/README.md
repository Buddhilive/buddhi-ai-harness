...
```yaml
- id: llm-replay
  name: '@buddhilive/dsh-llm-replay'
  config:
    providers:
...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-llm-replay) is the exhaustive source for every accepted field and its JSDoc.
