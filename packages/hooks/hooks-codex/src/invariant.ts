/**
 * Package-owned invariant companion for `@buddhilive/dsh-hooks-codex`.
 * @module @buddhilive/dsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-hooks-codex'
