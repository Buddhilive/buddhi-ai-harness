/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-attachment`.
 * @module @buddhilive/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-attachment'
