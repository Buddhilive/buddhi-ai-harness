/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-conversation`.
 * @module @buddhilive/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-conversation'
