/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-ask-user`.
 * @module @buddhilive/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-ask-user'
