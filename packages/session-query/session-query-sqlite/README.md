...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-session-query-sqlite) is the exhaustive source for every accepted field and its JSDoc.
