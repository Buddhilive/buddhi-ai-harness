/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-renderer`.
 * @module @buddhilive/dsh-client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@buddhilive/dsh-client-ui-slots'
import type { InvariantInstaller } from '@buddhilive/dsh-invariants'

const PACKAGE_NAME = '@buddhilive/dsh-client-ui-renderer'
