/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-cordis`.
 * @module @buddhilive/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-cordis'
