/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-title`.
 * @module @buddhilive/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-title'
