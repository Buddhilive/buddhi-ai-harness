/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-goal`.
 * @module @buddhilive/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-goal'
