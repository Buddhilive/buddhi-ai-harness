 ...
 *
 * @module @buddhilive/dsh-session
 */

import { Context, Service } from '@deepseek-ai/cordis'
import { isAbsolute } from 'node:path'
import { brandString } from '@buddhilive/dsh-brand'
import { deepFreeze, snapshotJsonValue } from '@buddhilive/dsh-util-values'
import { scopeOf, scopeTarget } from '@buddhilive/dsh-scope'
import type { Scoped } from '@buddhilive/dsh-scope'
import type { Message } from '@buddhilive/dsh-llm'
import { SESSION_FORMAT_VERSION } from './types.ts'
import type { TypertLookup } from '@buddhilive/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@buddhilive/dsh-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@buddhilive/dsh-session#Session',
        wireTypeSymbol: '@buddhilive/dsh-session/types#SessionId',
