/** Package-owned session-event invariants for sandbox policy. @module @buddhilive/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@buddhilive/dsh-sandbox-policy'
