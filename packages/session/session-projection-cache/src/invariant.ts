/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-projection-cache`.
 * @module @buddhilive/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-projection-cache'
