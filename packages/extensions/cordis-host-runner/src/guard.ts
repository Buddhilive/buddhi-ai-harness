 ...
 * @module @buddhilive/dsh-cordis-host-runner/guard
 */

import { Context } from '@deepseek-ai/cordis'
import type { Plugin } from '@deepseek-ai/cordis'
import { scopeOf } from '@buddhilive/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@buddhilive/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@buddhilive/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
