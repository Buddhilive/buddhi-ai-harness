/** Package-owned goal-round prompt invariants. @module @buddhilive/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@deepseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@buddhilive/dsh-goal'
...
const PACKAGE_NAME = '@buddhilive/dsh-goal-round-driver'
