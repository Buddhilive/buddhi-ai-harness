/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-user-questions`.
 * @module @buddhilive/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-user-questions'
