/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-cordis`.
 * @module @buddhilive/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-cordis'
