/**
 * Package-owned invariant companion for `@buddhilive/dsh-file-reference-local`.
 * @module @buddhilive/dsh-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-file-reference-local'
