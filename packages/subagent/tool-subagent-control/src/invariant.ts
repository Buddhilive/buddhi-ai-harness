/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-subagent-control`.
 * @module @buddhilive/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-subagent-control'
