 ...
 * Concrete
 * providers such as `@buddhilive/dsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @buddhilive/dsh-skill
 */

import { Context, Service } from '@deepseek-ai/cordis'
import type {} from '@buddhilive/dsh-llm'
import { assertNever } from '@buddhilive/dsh-util-values'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@buddhilive/dsh-scope'
