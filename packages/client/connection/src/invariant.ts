/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-connection`.
 * @module @buddhilive/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-connection'
