/**
 * Package-owned invariant companion for `@buddhilive/dsh-command-goal`.
 * @module @buddhilive/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-command-goal'
