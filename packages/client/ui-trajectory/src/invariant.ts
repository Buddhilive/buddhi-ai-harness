/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-trajectory`.
 * @module @buddhilive/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-trajectory'
