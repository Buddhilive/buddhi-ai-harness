 ...
 *
 * The seam itself lives in `@buddhilive/dsh-compaction`, which re-exports these
 ...
 *
 * @module @buddhilive/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@buddhilive/dsh-llm/message'
