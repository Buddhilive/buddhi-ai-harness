/**
 * Package-owned invariant companion for `@buddhilive/dsh-authorization`.
 * @module @buddhilive/dsh-authorization/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantFailure, InvariantInstaller } from '@buddhilive/dsh-invariants'

const PACKAGE_NAME = '@buddhilive/dsh-authorization'
