...
import * as fs from '@buddhilive/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/fs.ts'
import * as fsp from '@buddhilive/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/fs/promises.ts'
import type { VfsBigIntStats, VfsMutationSink, VfsStats } from '@buddhilive/dsh-experimental-webworker-runtime/src/storage/types.ts'
