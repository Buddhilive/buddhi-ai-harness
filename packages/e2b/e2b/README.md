...
```yaml
- name: '@buddhilive/dsh-e2b'
  config:
    apiKey: <E2B API key>
    cwd: /home/user/workspace
    timeoutMs: 300000

- name: '@buddhilive/dsh-subprocess-e2b'
- name: '@buddhilive/dsh-fs-e2b'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-e2b) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-e2b) — every accepted config field and its source declaration.
