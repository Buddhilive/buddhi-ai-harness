/**
 * Package-owned invariant companion for `@buddhilive/dsh-command-feedback`.
 * @module @buddhilive/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-command-feedback'
