/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-query`.
 * @module @buddhilive/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-query'
