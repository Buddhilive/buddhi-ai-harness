/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-terminal`.
 * @module @buddhilive/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-terminal'
