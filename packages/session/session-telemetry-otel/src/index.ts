 ...
 *
 * @module @buddhilive/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@deepseek-ai/schemastery'
import type { Context } from '@deepseek-ai/cordis'
import type {} from '@buddhilive/dsh-command-feedback'
import {
...
} from '@buddhilive/dsh-session-telemetry'
import { APP_IDENTITY } from '@buddhilive/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@buddhilive/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@buddhilive/dsh-session-telemetry-otel/ops', version)
