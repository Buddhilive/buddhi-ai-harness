/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-telemetry-otel`.
 * @module @buddhilive/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-telemetry-otel'
