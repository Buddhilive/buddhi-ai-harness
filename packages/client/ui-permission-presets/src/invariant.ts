/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-permission-presets`.
 * @module @buddhilive/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-permission-presets'
