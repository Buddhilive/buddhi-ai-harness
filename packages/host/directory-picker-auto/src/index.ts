 ...
 * @module @buddhilive/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@buddhilive/dsh-host-directory-picker-native',
  browse: '@buddhilive/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@buddhilive/dsh-client-ui-directory-picker-native',
  browse: '@buddhilive/dsh-client-ui-directory-picker-browse',
}
