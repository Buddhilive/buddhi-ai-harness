/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-projection`.
 * @module @buddhilive/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-projection'
