...
import { en as commonEn } from '@buddhilive/dsh-client-locale/src/locales/en.ts'
...
import { en, zh } from '@buddhilive/dsh-client-ui-conversation/src/client/locales.ts'
