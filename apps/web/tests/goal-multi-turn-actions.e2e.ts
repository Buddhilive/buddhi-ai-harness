...
import { parseSessionLog } from '@buddhilive/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@buddhilive/dsh-session'
import type {} from '@buddhilive/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@buddhilive/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@buddhilive/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@buddhilive/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@buddhilive/dsh-skill-filesystem"}\n',
