/**
 * Package-owned invariant companion for `@buddhilive/dsh-pwsh-sandbox`.
 * @module @buddhilive/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-pwsh-sandbox'
