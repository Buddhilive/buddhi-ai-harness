/**
 * Package-owned invariant companion for `@buddhilive/dsh-repeat-tool-reminder`.
 * @module @buddhilive/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-repeat-tool-reminder'
