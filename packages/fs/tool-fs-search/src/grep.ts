 ...
 *
 * @module @buddhilive/dsh-tool-fs-search/grep
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@buddhilive/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@buddhilive/dsh-tools'
import type { RetainedItems } from '@buddhilive/dsh-output-retention'
import type { SpillRef } from '@buddhilive/dsh-spill'
