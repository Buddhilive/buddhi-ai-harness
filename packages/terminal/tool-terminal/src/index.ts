 ...
 * @module @buddhilive/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@buddhilive/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@buddhilive/dsh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @buddhilive/dsh-jobs and @buddhilive/dsh-tool-jobs')
