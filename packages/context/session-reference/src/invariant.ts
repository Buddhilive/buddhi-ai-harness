/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-reference`.
 * @module @buddhilive/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-reference'
