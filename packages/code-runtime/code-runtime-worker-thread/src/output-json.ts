/** JSON string-prefix accounting for the outer-output ledger. @module @buddhilive/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@buddhilive/dsh-code-runtime'
