/** Package-owned scoped-dispatch invariants. @module @buddhilive/dsh-scope/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@buddhilive/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@buddhilive/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@buddhilive/dsh-scope'
