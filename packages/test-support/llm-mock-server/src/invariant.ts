/**
 * Package-owned invariant companion for `@buddhilive/dsh-llm-mock-server`.
 * @module @buddhilive/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-llm-mock-server'
