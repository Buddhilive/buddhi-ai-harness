...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-agent-default-model) — every accepted config field and its source declaration.
