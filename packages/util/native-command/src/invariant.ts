/**
 * Package-owned invariant companion for `@buddhilive/dsh-native-command`.
 * @module @buddhilive/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-native-command'
