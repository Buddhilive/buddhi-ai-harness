...
```yaml
- name: '@buddhilive/dsh-typert-registry'
- name: '@buddhilive/dsh-typert-loader'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-typert-loader) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-typert-loader) — the `packages` field declaration and JSDoc.
