/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-fs-search`.
 * @module @buddhilive/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-fs-search'
