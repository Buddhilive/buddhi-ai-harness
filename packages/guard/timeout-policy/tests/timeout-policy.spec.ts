/**
 * Unit + real-load-path coverage for @buddhilive/dsh-tool-call-timeout-policy. The
...
import { ToolCallId, HarnessError } from '@buddhilive/dsh-llm'
import SystemPrompt from '@buddhilive/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@buddhilive/dsh-tools'
import * as timeoutPolicy from '@buddhilive/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@buddhilive/dsh-tool-call-timeout-policy'
