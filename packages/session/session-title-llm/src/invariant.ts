/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-title-llm`.
 * @module @buddhilive/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-title-llm'
