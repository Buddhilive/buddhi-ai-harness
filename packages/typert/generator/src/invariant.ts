/**
 * Package-owned invariant companion for `@buddhilive/dsh-typert-generator`.
 * @module @buddhilive/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-typert-generator'
