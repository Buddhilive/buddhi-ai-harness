...
import * as GoalSessionInvariant from '@buddhilive/dsh-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@buddhilive/dsh-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@buddhilive/dsh-invariants'
import SessionStore, { SessionId, type Session } from '@buddhilive/dsh-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@buddhilive/dsh-goal-round-driver',
    }))
  })
