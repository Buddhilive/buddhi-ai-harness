...
import LlmRuntime, { createMessage, createUserMessage } from '@buddhilive/dsh-llm'
...
import * as LlmPiAi from '@buddhilive/dsh-llm-pi-ai'
...
async function loadComposition(): Promise<{ ctx: Context; settingsPath: string }> {
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@buddhilive/dsh-llm-pi-ai', LlmPiAi],
  ])
  ctx.loader.internal = {
    version: 'v2',
