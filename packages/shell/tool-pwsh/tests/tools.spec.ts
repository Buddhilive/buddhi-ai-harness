...
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellRunResult } from '@buddhilive/dsh-shell'
...
import type { ShellProcessRead } from '@buddhilive/dsh-shell'
