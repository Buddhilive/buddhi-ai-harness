...
import AuthorizationService from '@buddhilive/dsh-authorization'
import type { AuthorizationInteraction, AuthorizationNotice, AuthorizationPrompt } from '@buddhilive/dsh-authorization'
import LocalCredentialProvider from '@buddhilive/dsh-credentials-local'
import type { CredentialKey } from '@buddhilive/dsh-credentials'
