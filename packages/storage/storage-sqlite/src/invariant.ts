/**
 * Package-owned invariant companion for `@buddhilive/dsh-storage-sqlite`.
 * @module @buddhilive/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-storage-sqlite'
