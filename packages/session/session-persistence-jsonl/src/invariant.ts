/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-persistence-jsonl`.
 * @module @buddhilive/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-persistence-jsonl'
