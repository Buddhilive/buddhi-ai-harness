/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-settings-general`.
 * @module @buddhilive/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-settings-general'
