...
import { SlotCore, standardHookPropName } from '@buddhilive/dsh-client-ui-slots'
import type {
...
export class SlotRegistry extends Service {
  ...
  private rebuildRootBinding(): void {
    ...
    const keyedHooks: Record<string, import('@buddhilive/dsh-client-ui-slots').KeyedStandardSource> = {}
