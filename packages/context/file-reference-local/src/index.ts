 ...
 *
 * @module @buddhilive/dsh-file-reference-local
 */
...
} from '@buddhilive/dsh-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@buddhilive/dsh-file-reference'
export { activeAtToken, formatFileMention } from '@buddhilive/dsh-file-reference/grammar'
