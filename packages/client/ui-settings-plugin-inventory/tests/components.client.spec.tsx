...
const SNAPSHOT = {
  entries: [
    ...
    { entryId: 'bash-host', moduleName: '@buddhilive/dsh-tool-bash', enabled: false, fiberPhase: null },
    { entryId: 'fs-host', moduleName: '@buddhilive/dsh-tool-fs', enabled: false, fiberPhase: null },
  ...
  agentPresets: [
    {
      ...
      isDefault: true,
      rows: [
        { entryId: 'bash', moduleName: '@buddhilive/dsh-tool-bash', enabled: true, fiberPhase: 'active' },
        { entryId: 'fs', moduleName: '@buddhilive/dsh-tool-fs', enabled: true, fiberPhase: null },
        {
          entryId: 'pwsh',
    ...
    },
    {
      ...
      isDefault: false,
      rows: [
        { entryId: 'bash', moduleName: '@buddhilive/dsh-tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'bash-fork', moduleName: '@buddhilive/dsh-tool-bash', enabled: true, fiberPhase: null },
        { entryId: 'fs', moduleName: '@buddhilive/dsh-tool-fs', enabled: 'conditional', fiberPhase: null },
      ],
    },
