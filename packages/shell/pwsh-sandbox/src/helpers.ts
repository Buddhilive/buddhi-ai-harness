 ...
 * mirror of `@buddhilive/dsh-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @buddhilive/dsh-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@buddhilive/dsh-shell'
import type { RunnerFailureRule } from '@buddhilive/dsh-sandbox'
