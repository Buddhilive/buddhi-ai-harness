/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-theme`.
 * @module @buddhilive/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-theme'
