...
import AgentRegistry, { assembleContextFor } from '@buddhilive/dsh-agent'
import AgentLoop from '@buddhilive/dsh-agent-loop'
import InvariantRegistry from '@buddhilive/dsh-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@buddhilive/dsh-agent-presets'
import * as AgentPresetsInvariant from '@buddhilive/dsh-agent-presets/invariant'
