/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-primitives`.
 * @module @buddhilive/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-primitives'
