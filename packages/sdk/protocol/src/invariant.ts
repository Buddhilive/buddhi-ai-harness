/**
 * Package-owned invariant companion for `@buddhilive/dsh-sdk-protocol`.
 * @module @buddhilive/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-sdk-protocol'
