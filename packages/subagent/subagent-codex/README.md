...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-subagent-codex) — every accepted config field and its source declaration.
