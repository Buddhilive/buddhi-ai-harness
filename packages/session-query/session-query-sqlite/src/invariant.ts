/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-query-sqlite`.
 * @module @buddhilive/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-query-sqlite'
