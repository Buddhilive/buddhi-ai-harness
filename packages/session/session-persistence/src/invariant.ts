/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-persistence`.
 * @module @buddhilive/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-persistence'
