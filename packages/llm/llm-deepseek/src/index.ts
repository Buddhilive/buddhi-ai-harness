 ...
 * @module @buddhilive/dsh-llm-deepseek
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { assertUsableApiKey, LlmError, resolveImageAttachmentAccess, resolveRetryPolicy, RetryPolicySchema } from '@buddhilive/dsh-llm'
import type { ModelModality, RetryPolicyConfig } from '@buddhilive/dsh-llm'
import type {} from '@buddhilive/dsh-fs'
import { credentialRef } from '@buddhilive/dsh-credentials'
import { launchEnvironmentOf, type LaunchEnvironmentSnapshot } from '@buddhilive/dsh-launch-environment'
import type {} from '@buddhilive/dsh-settings'
import { MAX_TIMER_DELAY_MS } from '@buddhilive/dsh-timeout'
import { deepEqualJson } from '@buddhilive/dsh-util-values'
import { getOrCreateAnonymousUserId, type AnonymousUserId } from '@buddhilive/dsh-anonymous-user-id'
import {
