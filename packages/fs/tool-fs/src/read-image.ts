 ...
 * @module @buddhilive/dsh-tool-fs/src/read-image
 */

import { basename, extname } from 'node:path'
import type { Context } from '@deepseek-ai/cordis'
import { AttachmentError, AttachmentId } from '@buddhilive/dsh-attachment'
import type { ImageAttachmentRef, ImageMediaType } from '@buddhilive/dsh-attachment'
import type { ContentBlock } from '@buddhilive/dsh-llm'
import { defineTool } from '@buddhilive/dsh-tools'
import type { GenericCallView, ToolExecution } from '@buddhilive/dsh-tools'
