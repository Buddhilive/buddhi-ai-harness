/**
 * Package-owned invariant companion for `@buddhilive/dsh-agent-tool-presentation`.
 * @module @buddhilive/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-agent-tool-presentation'
