...
import { renderIndexInjections, type WebServer, type WebRoute } from '@buddhilive/dsh-host-webserver'
...
const MODULES_ID = '@buddhilive/dsh-client-modules'
const UI_RENDERER_ID = '@buddhilive/dsh-client-ui-renderer'
