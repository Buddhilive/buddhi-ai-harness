...
import type { GenericCallView, ToolResult, WebFetchResultView } from '@buddhilive/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@buddhilive/dsh-web'
import { assertNever, type JsonValue } from '@buddhilive/dsh-util-values'
 ...
 * `@buddhilive/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@buddhilive/dsh-tool-call-timeout-policy` to enforce.
