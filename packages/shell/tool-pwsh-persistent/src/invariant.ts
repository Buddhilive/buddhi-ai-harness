/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-pwsh-persistent`.
 * @module @buddhilive/dsh-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-pwsh-persistent'
