...
import GoalService, { GoalId, applyGoalProjection, foldGoal, goalProjectionDefinition } from '@buddhilive/dsh-goal'
import type { GoalProjection, GoalProjectionState, GoalRef } from '@buddhilive/dsh-goal'
