 ...
 * @module @buddhilive/dsh-agent-presets
 */
...
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@buddhilive/dsh-scope'
...
import type SettingsService from '@buddhilive/dsh-settings'
import type { SettingsScope } from '@buddhilive/dsh-settings'
