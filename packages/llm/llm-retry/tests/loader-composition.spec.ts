...
import LlmRuntime, { createUserMessage, LlmAdapter, LlmError, resolveRetryPolicy  } from '@buddhilive/dsh-llm'
import type { GenerateOptions, ResolvedRetryPolicy, StreamChunk } from '@buddhilive/dsh-llm'
...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@buddhilive/dsh-llm-retry', retry],
    ['@buddhilive/dsh-agent-loop', AgentLoop],
  ])
