/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-session-query`.
 * @module @buddhilive/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-session-query'
