 ...
 *
 * @module @buddhilive/dsh-sdk-client/types
 */

import type { ContentBlock, ReasoningEffortId } from '@buddhilive/dsh-llm'
import type { SdkPromptContentBlock } from '@buddhilive/dsh-sdk-protocol'
...
export interface HarnessClientOptions {
   ...
   * credential policy (see `scrubbedParentEnv` in `@buddhilive/dsh-subprocess`
