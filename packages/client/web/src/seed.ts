...
import * as ClientStore from '@buddhilive/dsh-client-store'
import * as UiSlots from '@buddhilive/dsh-client-ui-slots'
import * as UiPrimitives from '@buddhilive/dsh-client-ui-primitives'
...
export function getStaticModules(): Record<string, unknown> {
  ...
  return {
    ...
    '@buddhilive/dsh-client-store': ClientStore,
    '@buddhilive/dsh-client-ui-slots': UiSlots,
    '@buddhilive/dsh-client-ui-primitives': UiPrimitives,
