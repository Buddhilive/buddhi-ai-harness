/**
 * Package-owned invariant companion for `@buddhilive/dsh-code-runtime-python`.
 * @module @buddhilive/dsh-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-code-runtime-python'
