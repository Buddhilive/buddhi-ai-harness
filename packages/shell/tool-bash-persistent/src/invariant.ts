/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-bash-persistent`.
 * @module @buddhilive/dsh-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-bash-persistent'
