/**
 * Package-owned invariant companion for `@buddhilive/dsh-host-frontend-static`.
 * @module @buddhilive/dsh-host-frontend-static/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@buddhilive/dsh-invariants'

const PACKAGE_NAME = '@buddhilive/dsh-host-frontend-static'
