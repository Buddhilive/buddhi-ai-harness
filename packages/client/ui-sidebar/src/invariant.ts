/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-sidebar`.
 * @module @buddhilive/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-sidebar'
