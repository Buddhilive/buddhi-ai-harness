/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-title-all-prompts-llm`.
 * @module @buddhilive/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-title-all-prompts-llm'
