...
```yaml
- id: mcp-github
  name: '@buddhilive/dsh-mcp-client'
  config:
    serverName: github
    transport: stdio
    command: npx
...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-mcp-client) is the exhaustive source for every accepted field.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-mcp-client) — every accepted config field and its source declaration.
