...
import * as Connection from '@buddhilive/dsh-client-connection'
import LocalCredentials from '@buddhilive/dsh-credentials-local'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "    host: '127.0.0.1'",
    '    port: 0',
    "- name: '@buddhilive/dsh-client-connection'",
    '- id: frontend',
    "  name: '@buddhilive/dsh-host-frontend-static'",
    '  config:',
    `    distIndex: '${distIndex}'`,
    '',
  ].join('\n'))
  ...
  const modules = new Map<string, unknown>([
    ['@buddhilive/dsh-credentials-local', LocalCredentials],
    ['@buddhilive/dsh-host-webserver', HttpServer],
    ['@buddhilive/dsh-client-connection', Connection],
    ['@buddhilive/dsh-host-frontend-static', FrontendStatic],
  ])
