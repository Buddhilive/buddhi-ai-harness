/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-locale`.
 * @module @buddhilive/dsh-client-locale/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-locale'
