 ...
 *
 * @module @buddhilive/dsh-agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@buddhilive/dsh-fs'
import { dshHomeDisplay } from '@buddhilive/dsh-home-paths'
