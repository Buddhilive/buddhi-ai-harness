/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-subagent-report`.
 * @module @buddhilive/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-subagent-report'
