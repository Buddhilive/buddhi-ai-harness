...
import LlmRuntime, { createUserMessage, ToolCallId, type Message, type StreamChunk } from '@buddhilive/dsh-llm'
import SessionStore, { Session, SessionId, SESSION_FORMAT_VERSION, type SessionEvent, type UserMessage } from '@buddhilive/dsh-session'
import SessionProjectionRegistry from '@buddhilive/dsh-session-projection'
import AgentRegistry, { agentEvents, Inbox, type Agent } from '@buddhilive/dsh-agent'
import AgentLoop, { turnBoundaryProjectionDefinition } from '@buddhilive/dsh-agent-loop'
import { FileSystem, FsTargetKey, FsVersion } from '@buddhilive/dsh-fs'
import type {
  FsDirEntry,
  FsEditOutcome,
  FsEditRequest,
...
import ToolRuntime, { defineContentToolFixture } from '@buddhilive/dsh-tools'
import type {
  ToolExecution,
  ToolExecutionToken,
} from '@buddhilive/dsh-tools'
import * as ToolFs from '@buddhilive/dsh-tool-fs'
import {
  discoverBaselineInstructionFiles,
  loadBaselineInstructions,
  renderWorkspaceContext,
} from '@buddhilive/dsh-agent-instructions'
import {
...
describe('workspace context instruction discovery', () => {
  ...
  it('labels the default DSH home as ~/.dsh when HOME points at the configured default', async () => {
    ...
    try {
      ...
      const isolated = await import('@buddhilive/dsh-agent-instructions')
