/**
 * Package-owned invariant companion for `@buddhilive/dsh-compaction-tool-result-pruner`.
 * @module @buddhilive/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-compaction-tool-result-pruner'
