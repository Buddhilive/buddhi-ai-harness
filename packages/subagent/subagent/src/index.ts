 ...
 * (`@buddhilive/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@buddhilive/dsh-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@buddhilive/dsh-tools'
import type { ContentBlock, MessageId } from '@buddhilive/dsh-llm'
