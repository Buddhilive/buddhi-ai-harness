/**
 * Package-owned invariant companion for `@buddhilive/dsh-user-questions`.
 * @module @buddhilive/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-user-questions'
