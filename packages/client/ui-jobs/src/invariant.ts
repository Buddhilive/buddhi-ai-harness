/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-jobs`.
 * @module @buddhilive/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-jobs'
