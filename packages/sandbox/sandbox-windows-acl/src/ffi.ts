...
import {
  ...
  isNullPtr,
  throwLastError,
} from '@buddhilive/dsh-win32-process'
import type { NativePtr, Win32ProcessBindings } from '@buddhilive/dsh-win32-process'
...
export type { NativePtr } from '@buddhilive/dsh-win32-process'
