...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-experimental-inspector) is the exhaustive source for accepted fields and their declarations.
...
import type { InspectorJsonValue } from '@buddhilive/dsh-experimental-inspector'
