...
import WebRuntime, { WebError } from '@buddhilive/dsh-web'
import {
  DeepSeekSearchProvider,
  DEEPSEEK_PROVIDER_ID,
} from '@buddhilive/dsh-web-search-deepseek'
import * as deepseekPlugin from '@buddhilive/dsh-web-search-deepseek'
import { citationSnippets, mapAnthropicResponse } from '../src/provider.ts'
import type { AnthropicResponse } from '@buddhilive/dsh-web-search-deepseek/src/types.ts'

/** Construct the provider over a fixed options value; production passes a live thunk. */
import type { DeepSeekSearchProviderOptions } from '@buddhilive/dsh-web-search-deepseek'
