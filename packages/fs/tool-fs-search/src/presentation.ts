 ...
 * model-facing render consumes ({@link module:@buddhilive/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @buddhilive/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@buddhilive/dsh-tool-fs-search/grep} `formatGrepMatches`), so
