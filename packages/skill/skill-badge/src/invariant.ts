/**
 * Package-owned invariant companion for `@buddhilive/dsh-skill-badge`.
 * @module @buddhilive/dsh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-skill-badge'
