 ...
 * @module @buddhilive/dsh-tool-fs/src/write
 */

import type { Context } from '@deepseek-ai/cordis'
import { defineTool } from '@buddhilive/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@buddhilive/dsh-tools'
import type { FsWriteOutcome } from '@buddhilive/dsh-fs'
