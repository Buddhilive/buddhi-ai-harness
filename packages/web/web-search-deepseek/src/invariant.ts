/**
 * Package-owned invariant companion for `@buddhilive/dsh-web-search-deepseek`.
 * @module @buddhilive/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-web-search-deepseek'
