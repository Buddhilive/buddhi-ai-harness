/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-test-runtime`.
 * @module @buddhilive/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-test-runtime'
