/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-deliverables`.
 * @module @buddhilive/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-deliverables'
