/**
 * Package-owned invariant companion for `@buddhilive/dsh-subagent-codex`.
 * @module @buddhilive/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-subagent-codex'
