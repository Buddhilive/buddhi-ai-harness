/**
 * Package-owned invariant companion for `@buddhilive/dsh-launch-environment`.
 * @module @buddhilive/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-launch-environment'
