/**
 * Package-owned invariant companion for `@buddhilive/dsh-jobs-local`.
 * @module @buddhilive/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-jobs-local'
...
/**
 * No runtime invariant: `@buddhilive/dsh-jobs/invariant` owns per-snapshot identity, status,
