...
import { bootInjections, orderByModuleGraph } from '@buddhilive/dsh-client-modules'
import type { ClientModuleLoaderTarget, WebBootEntry, WebBootGraph } from '@buddhilive/dsh-client-modules/client'
import { AppWebEntry } from '@buddhilive/dsh-client-web'
...
const appBoot = await import(pathToFileURL(webBundleResolver.resolve('@buddhilive/dsh-app-boot')).href) as unknown as BootComposition
...
const BOOTSTRAP_IDS = ['@buddhilive/dsh-client-modules'] as const
