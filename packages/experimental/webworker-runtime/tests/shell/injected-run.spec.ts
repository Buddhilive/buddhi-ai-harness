...
import { filesystemError } from '@buddhilive/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import type {
  ShellDirent, ShellFileSystem, ShellRunOutcome, ShellStats,
} from '@buddhilive/dsh-experimental-webworker-runtime/src/shell/types.ts'
