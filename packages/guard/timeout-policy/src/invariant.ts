/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-call-timeout-policy`.
 * @module @buddhilive/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-call-timeout-policy'
