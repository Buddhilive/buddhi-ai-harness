/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-slots`.
 * @module @buddhilive/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-slots'
