/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-commands`.
 * @module @buddhilive/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-commands'
