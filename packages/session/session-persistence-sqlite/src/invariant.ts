/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-persistence-sqlite`.
 * @module @buddhilive/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-persistence-sqlite'
