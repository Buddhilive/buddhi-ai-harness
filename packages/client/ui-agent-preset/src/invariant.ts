/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-agent-preset`.
 * @module @buddhilive/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-agent-preset'
