...
import { Win32Error } from '@buddhilive/dsh-win32-process'
import { ERROR_BROKEN_PIPE } from '@buddhilive/dsh-win32-process/src/abi.ts'
import { PROCESS_INFORMATION } from '@buddhilive/dsh-win32-process/src/ffi.ts'
