...
import { seatbeltProfileArgs } from '@buddhilive/dsh-sandbox-local/src/profiles.ts'
 ...
 * confinement is covered by `@buddhilive/dsh-sandbox-local`. Skips off macOS or when
