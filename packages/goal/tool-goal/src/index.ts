 ...
 * @module @buddhilive/dsh-tool-goal
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { GoalId } from '@buddhilive/dsh-goal'
import type { GoalRef, GoalView } from '@buddhilive/dsh-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@buddhilive/dsh-llm'
import { defineTool } from '@buddhilive/dsh-tools'
import type { GenericCallView } from '@buddhilive/dsh-tools'
import {
  completionAuthority,
  goalToolExecution,
  requireDirectHuman,
