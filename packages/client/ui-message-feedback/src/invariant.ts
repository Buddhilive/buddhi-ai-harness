/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-message-feedback`.
 * @module @buddhilive/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-message-feedback'
