/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-modules`.
 * @module @buddhilive/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-modules'
