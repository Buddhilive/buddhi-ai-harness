/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-reference`.
 * @module @buddhilive/dsh-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-reference'
