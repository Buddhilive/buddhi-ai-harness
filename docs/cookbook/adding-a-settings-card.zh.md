...
import type {} from '@buddhilive/dsh-client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@buddhilive/dsh-client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@buddhilive/dsh-client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
