/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-settings-plugins`.
 * @module @buddhilive/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-settings-plugins'
