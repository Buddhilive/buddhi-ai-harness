/**
 * Package-owned invariant companion for `@buddhilive/dsh-cordis-host-runner`.
 * @module @buddhilive/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-cordis-host-runner'
