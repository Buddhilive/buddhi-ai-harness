...
describe.skipIf(!requiredArtifacts)('Agent Teams built LIB service', () => {
  it('loads the Host service and its generated browser contribution under plain Node', async () => {
    ...
    expect(output).toEqual({
      ...
      methods: [
        '@buddhilive/dsh-experimental-agent-team#agentTeams/createTask',
        '@buddhilive/dsh-experimental-agent-team#agentTeams/updateTask',
        '@buddhilive/dsh-experimental-agent-team#agentTeams/view',
      ],
    })
  })
})
