/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-brand-official`.
 * @module @buddhilive/dsh-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-brand-official'
