/** Package-owned permission-preset event invariants. @module @buddhilive/dsh-permission-presets/invariant */
...
const PACKAGE_NAME = '@buddhilive/dsh-permission-presets'
