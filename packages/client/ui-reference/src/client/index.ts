 ...
 *
 * @module @buddhilive/dsh-client-ui-reference/client
 */
// Type-only: pulls the generated Remote API and ctx.remote merge through the Client assembly boundary.
import type {} from '@buddhilive/dsh-api-remotes/client'
// Type-only: pulls the locale plugin's Context merge (ctx.locale).
import type {} from '@buddhilive/dsh-client-locale/client'
import type { Context as ClientContext } from '@deepseek-ai/cordis'
import type { ISessions } from '@buddhilive/dsh-api-session-controller/client'
import { relativeTime } from '@buddhilive/dsh-client-ui-primitives'
import type {
  ClientSessionContext, InputTriggerCrumb, InputTriggerServiceContract, InputTriggerSource,
} from '@buddhilive/dsh-client-ui-input-trigger/client'
import { formatFileMention } from '@buddhilive/dsh-file-reference/grammar'
import type { FileReferenceCandidate } from '@buddhilive/dsh-file-reference/types'
import type { SessionReferenceMentionCandidate } from '@buddhilive/dsh-session-reference/types'
import { abbreviateHomePath } from '@buddhilive/dsh-util-workspace-path'
