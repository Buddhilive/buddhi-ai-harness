/**
 * Package-owned invariant companion for `@buddhilive/dsh-sdk-jsonrpc-server`.
 * @module @buddhilive/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-sdk-jsonrpc-server'
