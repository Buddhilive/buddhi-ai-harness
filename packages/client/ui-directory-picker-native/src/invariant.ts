/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-directory-picker-native`.
 * @module @buddhilive/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-directory-picker-native'
