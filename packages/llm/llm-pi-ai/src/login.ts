...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@buddhilive/dsh-authorization'
import { isCredentialKeySegment } from '@buddhilive/dsh-credentials'
