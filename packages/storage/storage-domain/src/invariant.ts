/**
 * Package-owned invariant companion for `@buddhilive/dsh-storage-domain`: every
 ...
 * @module @buddhilive/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-storage-domain'
