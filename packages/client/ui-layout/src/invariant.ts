/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-layout`.
 * @module @buddhilive/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-layout'
