...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@buddhilive/dsh-llm'
import type { GenerateOptions, StreamChunk } from '@buddhilive/dsh-llm'
...
import * as providerPlugin from '@buddhilive/dsh-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@buddhilive/dsh-session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@buddhilive/dsh-session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@buddhilive/dsh-session-title', SessionTitleService],
    ['@buddhilive/dsh-session-title-first-prompt-llm', providerPlugin],
  ])
