/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-plan`.
 * @module @buddhilive/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-plan'
