/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-subagent`.
 * @module @buddhilive/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-subagent'
