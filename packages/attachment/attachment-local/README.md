...
```yaml
- name: '@buddhilive/dsh-attachment-local'
```
...
The generated [configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-attachment-local) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-attachment-local) — every accepted config field and its source declaration.
