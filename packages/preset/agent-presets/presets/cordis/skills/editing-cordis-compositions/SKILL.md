...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@buddhilive/dsh-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@buddhilive/dsh-tool-workflow'
```
