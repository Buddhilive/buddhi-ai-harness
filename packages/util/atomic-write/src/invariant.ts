/**
 * Package-owned invariant companion for `@buddhilive/dsh-atomic-write`.
 * @module @buddhilive/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-atomic-write'
