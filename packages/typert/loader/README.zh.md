...
生成的[配置目录](../../../docs/config-catalog.zh.md#buddhilivedsh-typert-loader)是每个受支持字段的穷尽式真源。
...
- [生成配置目录](../../../docs/config-catalog.zh.md#buddhilivedsh-typert-loader)——`packages` 字段声明及其 JSDoc。
