/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-stats`.
 * @module @buddhilive/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-stats'
