/**
 * Package-owned invariant companion for `@buddhilive/dsh-credentials-local`.
 * @module @buddhilive/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-credentials-local'
