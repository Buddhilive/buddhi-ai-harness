/**
 * Package-owned invariant companion for `@buddhilive/dsh-agent-spine-demo`.
 * @module @buddhilive/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-agent-spine-demo'
