...
import * as invariant from '@buddhilive/dsh-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@buddhilive/dsh-command-compact', expect.any(Function))
    expect(() => {
