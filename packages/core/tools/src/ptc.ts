 ...
 * @module @buddhilive/dsh-tools/src/ptc
 */

import { brandString } from '@buddhilive/dsh-brand'
import { createUserMessage, HarnessError } from '@buddhilive/dsh-llm'
import type { ContentBlock, ToolCallId } from '@buddhilive/dsh-llm'
import type { CodeBindingFunction, CodeRunResult, CodeRuntime } from '@buddhilive/dsh-code-runtime'
import { snapshotJsonValue, type JsonValue } from '@buddhilive/dsh-util-values'
