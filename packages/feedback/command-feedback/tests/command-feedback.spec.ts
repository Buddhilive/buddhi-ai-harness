...
import CommandRuntime from '@buddhilive/dsh-commands'
import SessionStore, { foldSurface, Session, SessionId } from '@buddhilive/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@buddhilive/dsh-session-telemetry'
import * as commandFeedback from '@buddhilive/dsh-command-feedback'
...
vi.mock('@buddhilive/dsh-anonymous-user-id', () => ({
...
describe('@buddhilive/dsh-command-feedback registration', () => {
