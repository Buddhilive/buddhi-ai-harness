/**
 * Package-owned invariant companion for `@buddhilive/dsh-cordis-client-runner`.
 * @module @buddhilive/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-cordis-client-runner'
