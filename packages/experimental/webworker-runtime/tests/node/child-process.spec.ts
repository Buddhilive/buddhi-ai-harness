...
import { MemoryVfs } from '@buddhilive/dsh-experimental-webworker-runtime/src/storage/memory.ts'
import { setActiveVfs } from '@buddhilive/dsh-experimental-webworker-runtime/src/storage/active.ts'
import { spawn, spawnSync } from '@buddhilive/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'
import {
  LAUNCHER_FAILURE_EXIT, grantArgs, launcherPath, probe,
} from '@deepseek-ai/node-addon-landlock-run'
import { processAlive, signalProcess } from '@buddhilive/dsh-experimental-webworker-runtime/src/node/process-table.ts'
import { hostFileSystem } from '@buddhilive/dsh-experimental-webworker-runtime/src/shell/fs-access.ts'
import {
  LANDLOCK_EXECUTABLE, landlockFileSystem, parseLandlockArguments,
} from '@buddhilive/dsh-experimental-webworker-runtime/src/shell/process/landlock.ts'
import { spawnSubprocess } from '@buddhilive/dsh-subprocess-local/src/spawn.ts'

vi.mock('node:child_process', async () =>
  await import('@buddhilive/dsh-experimental-webworker-runtime/src/node/builtin_modules/implemented/child_process.ts'))
