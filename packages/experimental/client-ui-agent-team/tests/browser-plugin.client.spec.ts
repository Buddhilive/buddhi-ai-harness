...
import type { TeamMemberView as TeamRosterMember, TeamTaskId } from '@buddhilive/dsh-experimental-agent-team/client'
import type {} from '@buddhilive/dsh-experimental-agent-team/remote'
import { RemoteError } from '@buddhilive/dsh-client-test-runtime'
import type { TypertRemoteContribution } from '@buddhilive/dsh-typert-protocol'
...
const REMOTE: TypertRemoteContribution = {
  package: '@buddhilive/dsh-experimental-agent-team',
  descriptors: [],
}
