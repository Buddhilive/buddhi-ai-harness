/**
 * Package-owned invariant companion for `@buddhilive/dsh-terminal-bash`.
 * @module @buddhilive/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-terminal-bash'
