/**
 * Package-owned invariant companion for `@buddhilive/dsh-tmux-context`.
 * @module @buddhilive/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tmux-context'
