...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@buddhilive/dsh-credentials'
import type { CredentialKey, CredentialRecord } from '@buddhilive/dsh-credentials'
