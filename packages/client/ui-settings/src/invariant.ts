/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-settings`.
 * @module @buddhilive/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-settings'
