 ...
 * turn/step boundaries remain `@buddhilive/dsh-session` events.
 *
 * @module @buddhilive/dsh-agent
 */

import type { Context } from '@deepseek-ai/cordis'
import type { Scoped } from '@buddhilive/dsh-scope'
import type { LlmCallConfig, LlmFailure, ReasoningEffortId, ResolvedRetryPolicy } from '@buddhilive/dsh-llm'
import type { AgentCancelCause, Session, UserMessage } from '@buddhilive/dsh-session'
export type { AgentCancelCause } from '@buddhilive/dsh-session'
import type { Inbox } from './inbox.ts'
import type { Agent } from './types.ts'
export type { Agent } from './types.ts'
import type {} from '@buddhilive/dsh-system-prompt'
declare module '@buddhilive/dsh-system-prompt' {
...
declare module '@deepseek-ai/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@buddhilive/dsh-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
