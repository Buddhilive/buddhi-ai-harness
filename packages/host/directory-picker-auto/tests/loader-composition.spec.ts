...
import HttpServer from '@buddhilive/dsh-host-webserver'
import type { DirectoryPicker } from '@buddhilive/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@buddhilive/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@buddhilive/dsh-host-directory-picker-native'
...
const AUTO = '@buddhilive/dsh-host-directory-picker-auto'
const NATIVE = '@buddhilive/dsh-host-directory-picker-native'
const BROWSE = '@buddhilive/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@buddhilive/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@buddhilive/dsh-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@buddhilive/dsh-host-webserver', HttpServer],
