/**
 * Package-owned invariant companion for `@buddhilive/dsh-session-checkpoint-policy`.
 * @module @buddhilive/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-session-checkpoint-policy'
