 ...
 * @module @buddhilive/dsh-app-boot/profile
 */
...
export const PROFILE_TEMPLATES: Record<string, ProfileTemplate> = {
  ...
  web: {
    bundles: ['@buddhilive/dsh-base', '@buddhilive/dsh-web-app'],
    patchReload: 'live',
  },
  headless: {
...
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@buddhilive/dsh-base', '@buddhilive/dsh-web-app', '@buddhilive/dsh-headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@buddhilive/dsh-base']
 ...
 * `@buddhilive/dsh-base` (and every other in-box bundle) always comes from
