/**
 * Package-owned invariant companion for `@buddhilive/dsh-subprocess-e2b`.
 * @module @buddhilive/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-subprocess-e2b'
