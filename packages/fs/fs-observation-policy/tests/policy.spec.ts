...
import { FsTargetKey, FsVersion } from '@buddhilive/dsh-fs'
import type { FsObservation, FsTarget, FsWriteIntent } from '@buddhilive/dsh-fs'
import * as FsPolicy from '@buddhilive/dsh-fs-observation-policy'
import type { FsObservationActor } from '@buddhilive/dsh-fs-observation-policy'
