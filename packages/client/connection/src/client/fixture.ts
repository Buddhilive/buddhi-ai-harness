...
import {
  ...
  createUserMessage,
} from '@buddhilive/dsh-llm/message'
import { brandString } from '@buddhilive/dsh-brand'
import type { MessageId, ToolCallId } from '@buddhilive/dsh-llm/brand'
import type {
  AssistantMessage,
  ContentBlock,
  MessageSource,
...
import type {
  ...
  SessionHeader,
  SessionId,
} from '@buddhilive/dsh-session/types'
import type { JsonValue } from '@buddhilive/dsh-util-values'
import { isChunkRow, packChunkRuns } from '@buddhilive/dsh-session/chunk-rows'
import type { ChunkRow } from '@buddhilive/dsh-session/chunk-rows'
import type { TodoItem } from '@buddhilive/dsh-tool-todo/client'
// Type-only: the brand constructor is host-side; the fixture casts at its
// wire-fabrication boundary (the schema layer's one-cast-point posture).
import type { CommandId } from '@buddhilive/dsh-commands/brand'
import type { CommandDescriptor, CommandExecution, CommandResult } from '@buddhilive/dsh-commands/types'
import type { CredentialInfo } from '@buddhilive/dsh-credentials/types'
import type { DirectoryListing as FixtureDirectoryListing } from '@buddhilive/dsh-host-directory-picker/types'
import type { SettingsDescribeValue, SettingsNamespaceView } from '@buddhilive/dsh-settings/types'
import { deriveEventMessage, foldSurface } from '@buddhilive/dsh-session/surface'
...
function createFixtureWorld(options: FixtureOptions): FixtureWorld {
  ...
  const fixturePresets = new Map<string, { trust: 'system' | 'user'; content: string }>([
    ...
    ['minimal', { trust: 'system', content: "- id: tool-web-search\n  name: '@buddhilive/dsh-tool-web-search'\n" }],
    ['my-agent', { trust: 'user', content: "- id: tool-read\n  name: '@buddhilive/dsh-tool-read'\n" }],
  ])
