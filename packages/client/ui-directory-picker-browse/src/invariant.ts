/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-directory-picker-browse`.
 * @module @buddhilive/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-directory-picker-browse'
