/**
 * Package-owned invariant companion for `@buddhilive/dsh-host-webserver`.
 * @module @buddhilive/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-host-webserver'
