/**
 * Package-owned invariant companion for `@buddhilive/dsh-client-ui-model-selection`.
 * @module @buddhilive/dsh-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-client-ui-model-selection'
