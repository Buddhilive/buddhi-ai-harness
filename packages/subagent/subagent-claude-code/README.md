...
- [Generated configuration catalog](../../../docs/config-catalog.md#buddhilivedsh-subagent-claude-code) — every accepted config field and its source declaration.
