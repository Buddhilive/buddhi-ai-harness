/**
 * Package-owned invariant companion for `@buddhilive/dsh-subagent-dsh-sdk`.
 * @module @buddhilive/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-subagent-dsh-sdk'
