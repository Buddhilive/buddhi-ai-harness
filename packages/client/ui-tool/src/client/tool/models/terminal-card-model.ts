...
import type { TerminalBlockLabels, TerminalBlockProps } from '@buddhilive/dsh-client-ui-primitives'
...
/**
 * Parse the marker literals owned by `@buddhilive/dsh-shell/render` without
