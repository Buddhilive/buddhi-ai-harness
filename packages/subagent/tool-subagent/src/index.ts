 ...
 * @module @buddhilive/dsh-tool-subagent
 */

import type { Context } from '@deepseek-ai/cordis'
import z from '@deepseek-ai/schemastery'
import { scopeChainOf, scopeOf } from '@buddhilive/dsh-scope'
import { defineTool } from '@buddhilive/dsh-tools'
import type { Agent, AgentOptions } from '@buddhilive/dsh-agent'
...
import type { SubagentProvider, SubagentResult, SubagentRun } from '@buddhilive/dsh-subagent'
import type { JobOutcome } from '@buddhilive/dsh-jobs'
import {
...
export function apply(ctx: Context, config: Config): void {
  ...
  if (settings === undefined) {
    throw new Error(
      ...
      + '@buddhilive/dsh-tool-subagent/model-selection-settings in the Host scope',
    )
  }
