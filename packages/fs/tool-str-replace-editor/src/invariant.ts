/**
 * Package-owned invariant companion for `@buddhilive/dsh-tool-str-replace-editor`.
 * @module @buddhilive/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-tool-str-replace-editor'
