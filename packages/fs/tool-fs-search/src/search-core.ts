 ...
 *
 * @module @buddhilive/dsh-tool-fs-search/search-core
 */
...
import { ItemRetainer, TextRetainer } from '@buddhilive/dsh-output-retention'
import type { RetainedItems } from '@buddhilive/dsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@buddhilive/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@buddhilive/dsh-spill'
 ...
 * `@buddhilive/dsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@buddhilive/dsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@buddhilive/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@buddhilive/dsh-tool-fs-search/presentation} `grepSearchMeta`)
