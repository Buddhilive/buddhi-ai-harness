/**
 * Package-owned invariant companion for `@buddhilive/dsh-output-retention`.
 * @module @buddhilive/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-output-retention'
