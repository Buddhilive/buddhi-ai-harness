...
# @buddhilive/dsh-output-retention
...
```ts
import { ItemRetainer } from '@buddhilive/dsh-output-retention'
...
```ts
import { formatRetentionNotice } from '@buddhilive/dsh-output-retention'
