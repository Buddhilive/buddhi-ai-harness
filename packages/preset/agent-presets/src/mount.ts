 ...
 * @module @buddhilive/dsh-agent-presets/mount
 */
...
import { scopeOf, scopeParentOf, type ScopeKey } from '@buddhilive/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@buddhilive/dsh-*` row would fail to import. The
