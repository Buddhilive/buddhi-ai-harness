/**
 * Package-owned invariant companion for `@buddhilive/dsh-agent-presets`.
 * @module @buddhilive/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@buddhilive/dsh-agent-presets'

const PACKAGE_NAME = '@buddhilive/dsh-agent-presets'
