...
import type { CordisCatalogModel, ServiceMethodEntry } from '@buddhilive/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    ...
    .replaceAll('@buddhilive/dsh-tool-cordis/api-catalog', '@buddhilive/dsh-cordis-client-runner/client/api-catalog')
