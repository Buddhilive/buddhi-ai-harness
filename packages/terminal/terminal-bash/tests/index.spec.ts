...
import AgentRegistry, { Inbox, type Agent } from '@buddhilive/dsh-agent'
...
import TerminalSessionService, { TerminalBackendCleanupError, TerminalSessionId } from '@buddhilive/dsh-terminal'
import type { TerminalSendRequest, TerminalWaitReason } from '@buddhilive/dsh-terminal'
import { BashTerminalBackend, PWSH_PROMPT_SETUP } from '@buddhilive/dsh-terminal-bash'
import { ENCODING_PREAMBLE } from '@buddhilive/dsh-pwsh-local'
import * as ptyLocal from '@buddhilive/dsh-terminal-bash'
import type { ResolvedConfig } from '@buddhilive/dsh-terminal-bash/src/config.ts'
import type { LocalPtySession } from '@buddhilive/dsh-terminal-bash/src/session.ts'
import { SubprocessRuntime } from '@buddhilive/dsh-subprocess'
import type {
  SubprocessHandle,
  SubprocessSpawnSpec,
