...
import { scopeOf } from '@buddhilive/dsh-scope'
...
import SessionQueryEngine from '@buddhilive/dsh-session-query'
import SubagentService from '@buddhilive/dsh-subagent'
import * as SubagentFork from '@buddhilive/dsh-subagent-fork-in-process'
import * as SubagentSpawn from '@buddhilive/dsh-subagent-spawn-in-process'
import { renderPrompt } from '@buddhilive/dsh-system-prompt'
