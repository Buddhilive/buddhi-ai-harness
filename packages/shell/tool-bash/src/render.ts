 ...
 *
 * @module @buddhilive/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@buddhilive/dsh-shell'
import type { SandboxMode } from '@buddhilive/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@buddhilive/dsh-sandbox'
 ...
 * rendering story, owned by `@buddhilive/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@buddhilive/dsh-shell'
