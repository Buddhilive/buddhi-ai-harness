/**
 * Package-owned invariant companion for `@buddhilive/dsh-command-compact`.
 * @module @buddhilive/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@buddhilive/dsh-command-compact'
