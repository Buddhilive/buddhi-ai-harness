 ...
 * @module @buddhilive/dsh-web-search-deepseek/provider
 */

import { WebError } from '@buddhilive/dsh-web'
import type {
  WebSearchProvider,
  WebSearchRequest,
  WebSearchResult,
  WebSearchSource,
} from '@buddhilive/dsh-web'
import type { CredentialRef } from '@buddhilive/dsh-credentials'
import type {} from '@buddhilive/dsh-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@buddhilive/dsh-llm-deepseek` uses, so this
